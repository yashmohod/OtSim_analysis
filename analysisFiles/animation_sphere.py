...
scale = 1
traj1= analysis.expand_trajectory(np.load(r"C:\Users\mohod\Development\OtSim_analysis\data\D3\data\LCP_0.02_6983609.npy"))*scale
traj2= analysis.expand_trajectory(np.load(r"C:\Users\mohod\Development\OtSim_analysis\data\D3\data\LCP_0.03_1544562.npy"))*scale
traj3= analysis.expand_trajectory(np.load(r"C:\Users\mohod\Development\OtSim_analysis\data\D3\data\LCP_0.04_3245385.npy"))*scale
