...
Overview
--------
A particle suspended in a fluid (such as a pollen grain in water, viewed under a microscope) 
appears to jiggle randomly.
This is *Brownian motion*.
It occurs because the constantly-moving molecules in the fluid collide with the particle. 
The details depend on the interplay between these random collisions
